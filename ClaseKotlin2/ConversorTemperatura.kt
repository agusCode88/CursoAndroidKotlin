...
fun main() {
    ...
    val celsiusAFahrenheit: (Double) -> Double = { celsius -> (9.0 / 5.0 * celsius) + 32 }
    val kelvinACelsius: (Double) -> Double = { kelvin -> kelvin - 273.15 }
    val fahrenheAToKelvin: (Double) -> Double = { fahrenheit -> 5.0 / 9.0 * (fahrenheit - 32) + 273.15 }
    ...
    printFinalTemperature(10.0,"Fahrenheit", "Kelvin", fahrenheAToKelvin)
...
/*
Completa la función main() para que llame a la función printFinalTemperature() e imprima las siguientes
líneas. Debes pasar argumentos para la fórmula de conversión y temperatura.
Sugerencia: Te recomendamos usar valores Double para evitar el truncamiento de Integer durante las
