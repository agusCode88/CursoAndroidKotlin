...
fun ticketPrice(age: Int, isMonday: Boolean): Int {
    return when {
        ...
        age in 13..60 -> if (isMonday) 25 else 30 // Precio para adultos (13 a 60 años) con descuento los lunes
        age in 61..100 -> 20 // Precio para adultos mayores (61 años o más)
        else -> -1 // Precio no válido para edades fuera de las especificaciones
    }
}
